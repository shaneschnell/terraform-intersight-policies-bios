...
func TestFull(t *testing.T) {
	...
	instanceName := fmt.Sprintf("test-policies-bios-%s", uniqueId)
	...
	expectedJSONTemplate := `
{
	...
	"ConsoleRedirection": "serial-port-a",
	...
	"MemoryInterLeave": "1 Way Node Interleave",
...
`
	...
	iassert.AssertMOComply(t, fmt.Sprintf("/api/v1/bios/Policies/%s", moid), expectedJSONTemplate, vars)
}
