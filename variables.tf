...
variable "bios_template" {
  default     = ""
  description = <<-EOT
    Name of a BIOS Template to Configure.  Options are:
...
variable "cpu_perf_enhancement" {
  default     = "platform-default"
  description = <<-EOT
    IOS Token for setting Enhanced CPU Performance configuration.
    * platform-default - Default value used by the platform for the BIOS setting.
    * Auto - Auto for configuring CpuPerfEnhancement token.
    * Disabled - Disabled for configuring CpuPerfEnhancement token.
  EOT
  type        = string
}
...
variable "llc_alloc" {
  ...
  description = <<-EOT
    ...
    * platform-default - Default value used by the platform for the BIOS setting.
    * Auto - Auto for configuring LlcAlloc token
    * enabled - enabled for configuring LlcAlloc token.
    * disabled - disabled for configuring LlcAlloc token.
  EOT
  type        = string
}
...
variable "pcie_slots_cdn_enable" {
  default     = "platform-default"
  description = <<-EOT
